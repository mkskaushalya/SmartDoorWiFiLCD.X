...
void LCD_write_data(char data){
    ...
    PORTDbits.RD7 = (data & 0b10000000) >> 7;
    PORTDbits.RD6 = (data & 0b01000000) >> 6;
    PORTDbits.RD5 = (data & 0b00100000) >> 5;
    PORTDbits.RD4 = (data & 0b00010000) >> 4;


    LCD_pulse_clock();


    PORTDbits.RD7 = (data & 0b00001000) >> 3;
    PORTDbits.RD6 = (data & 0b00000100) >> 2;
    PORTDbits.RD5 = (data & 0b00000010) >> 1;
    PORTDbits.RD4 = (data & 0b00000001) ;
